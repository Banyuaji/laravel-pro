                    ...
                    <div class="uk-navbar-left">
                        <button class="uk-navbar-toggle uk-hidden@m" uk-toggle="target: #nav-offcanvas"
                            uk-navbar-toggle-icon></button><a class="uk-navbar-item uk-logo" href="index.html"><img
                                src="{{ asset('img/logo.svg') }}" width="90" height="32" alt="Logo"></a>
                                            ...
                                            <ul class="uk-navbar-dropdown-grid uk-child-width-1-5" uk-grid>
                                                <li>0
                                                    <div class="uk-margin-top uk-margin-bottom"><a class="uk-link-reset"
                                                            href="category.html"><img
                                                                ...
                                                                src="{{ asset('img/catalog/computers.svg') }}"
                                                ...
                                                <li>
                                                    <div class="uk-margin-top uk-margin-bottom"><a class="uk-link-reset"
                                                            href="category.html"><img
                                                                class="uk-display-block uk-margin-auto uk-margin-bottom"
                                                                src="{{ asset('img/catalog/phones.svg') }}"
                                                ...
                                                <li>
                                                    <div class="uk-margin-top uk-margin-bottom"><a class="uk-link-reset"
                                                            href="category.html"><img
                                                                class="uk-display-block uk-margin-auto uk-margin-bottom"
                                                                src="img/catalog/photo.svg" alt="Photo" width="80"
                                                                height="80">
                                            ...
                                            <ul class="uk-grid-small uk-child-width-1-6" uk-grid>
                                                <li>
                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                            ...
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="{!! file_get_contents('img/brands/apple.svg') !!}"
                                                                    alt="Apple"></figure>
                                                        </a></div>
                                                </li>
                                                <li>
                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                            ...
                                                            href="#" title="Samsung">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="{{ url('img/brands/samsung.svg') }}"
                                                                    alt="Samsung"></figure>
                                                        </a></div>
                                                </li>
                                                <li>
                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                            ...
                                                            href="#" title="Sony">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="{{ url('img/brands/sony.svg') }}" alt="Sony">
                                                            </figure>
                                                        </a></div>
                                                </li>
                                                <li>
                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                            ...
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="{{ url('img/brands/microsoft.svg') }}"
                                                ...
                                                <li>
                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                            ...
                                                            href="#" title="Intel">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="{{ url('img/brands/intel.svg') }}" alt="Intel">
                                                            </figure>
                                                        </a></div>
                                                </li>
                                                <li>
                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                            ...
                                                            href="#" title="HP">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="{{ url('img/brands/hp.svg') }}" alt="HP">
                                                            </figure>
                                                        </a></div>
                                                </li>
                                                <li>
                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                            ...
                                                            href="#" title="LG">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="{{ url('img/brands/lg.svg') }}" alt="LG">
                                                            </figure>
                                                        </a></div>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                            ...
                                                            href="#" title="ASUS">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="{{ url('img/brands/asus.svg') }}" alt="ASUS">
                                                            </figure>
                                                        </a></div>
                                                </li>
                                                <li>
                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                            ...
                                                            href="#" title="Acer">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="{!! file_get_contents('img/brands/acer.svg') !!}"
                                                                    alt="Acer"></figure>
                                                        </a></div>
                                                </li>
                                                <li>
                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                            ...
                                                            href="#" title="Dell">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="{{ url('img/brands/dell.svg') }}" alt="Dell">
                                                            </figure>
                                                        </a></div>
                                                </li>
                                                <li>
                                                    <div class="tm-ratio tm-ratio-4-3"><a
                                                            ...
                                                            href="#" title="Canon">
                                                            <figure class="tm-media-box-wrap"><img
                                                                    src="{{ url('img/brands/canon.svg') }}" alt="Canon">
                                                            </figure>
                                                        </a></div>
                                                </li>
                                            </ul>
